...
import (
	...
	"github.com/sagikazarmark/{{.ProjectName}}/internal/app/mga"
	"github.com/sagikazarmark/{{.ProjectName}}/internal/app/mga/todo/tododriver"
	"github.com/sagikazarmark/{{.ProjectName}}/internal/common/commonadapter"
	"github.com/sagikazarmark/{{.ProjectName}}/internal/platform/appkit"
	"github.com/sagikazarmark/{{.ProjectName}}/internal/platform/database"
	"github.com/sagikazarmark/{{.ProjectName}}/internal/platform/gosundheit"
	"github.com/sagikazarmark/{{.ProjectName}}/internal/platform/log"
	"github.com/sagikazarmark/{{.ProjectName}}/internal/platform/watermill"
)
...
const (
	...
	//
	// It {{.ProjectName}} itself, the actual instance needs to be identified via environment
	// and other details.
	appName = "mga"

	// friendlyAppName is the visible name {{.ProjectName}}.
...
func main() {
	...
	logger.Info{{.ProjectName}}", buildInfo.Fields())
